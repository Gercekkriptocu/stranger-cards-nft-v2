 ...
 */
async function createRepo(token: string, repoName: string, description: string): Promise<string> {
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const repoFullName = await createRepo(token, repoName, repoDescription);
